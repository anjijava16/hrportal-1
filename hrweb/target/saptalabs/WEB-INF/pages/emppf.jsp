		...
		<div id="empPFDetails" class="hidden">
			...
			<div id="employeePFList" style="padding:10px;">
				<div id="emppf">
					...
					<div id="addpf" style="width:100%; cursor: pointer; margin-top: 0px;" class="rightElement MRGR10PX MRGT10PX MRGB10PX">
					...
					<div align="center" style="width: 100%;" class="amount_table">
						<table   align ="center" class="optionTable">
							<tr>
								...
								<td align="left"  class="fyBillsPaidTd PADDLFT1PX BLD" ><span style="margin-left: 10px; font-weight:bold;">&#x20B9;</span><input id="currenttotalamttd" disabled style="border: 0; background-color: white; width:100px; font-weight:bold;" /></td>
							</tr>
						</table>
					</div>
			...
			<div id="editdetail" class="hidden">
				...
				<table>
					<tr>
						...
						<td align="right"><sup class="saptaColor">*</sup>PF Amount&nbsp;:</td>
						<td><input name="editemployeepf" id="editemployeepf" type="text"  onkeypress="return validateNumericWithPrecision(event)" /></td>
					</tr>
					<tr>
						<td align="right"><sup class="saptaColor">*</sup>PF Month&nbsp;:</td>
			...
			$('#pftable').DataTable({
		      ...
		      "footerCallback": function ( row, data, start, end, display ) {
		            ...
		            pageTotal = api
		             ...
		             $("#currenttotalamttd").val(pageTotal.toFixed(2));   
		        }
		    });
