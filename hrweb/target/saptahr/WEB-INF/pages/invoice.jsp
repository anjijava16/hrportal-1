...
<html>
	...
	<body>
					...
					<ul class="dropdown">
						...
						<li  class="active"><a href="#" >Payments</a> 
							<ul class="sub_menu">
							    <li><a href="#">Invoice</a>
									<ul>
										<li><a href="<%=request.getContextPath() %>/invoice/addinvoie">Add Invoice</a></li>
		...
		<!--Header End-->
		<!--Expense Type List-->
			<div id="invoicetrackingList">
				<div id = "Invoicetracking">
					<div class="dashboard">
						<div class="dashboardRow">
							<div class="cellA">
								<div class="info">
									<a href="<%=request.getContextPath() %>/invoice/viewinvoice"><h1 align="center"><b class="saptaColor">View </b>Invoice</h1></a>
				               </div>
						</div>
								
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/invoice/addinvoice"><h1 align="center"><b class="saptaColor">Add </b>Invoice</h1></a>
				               </div>
							</div>
						</div>
					</div>
