			...
			<div id = "employee_details">
				<div class="dashboard">
					<div class="dashboardRow">
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/assignment/viewassignment"><h1 align="center"><b class="saptaColor">View </b>Assignment</h1></a>
			                 </div>
						</div>
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/assignment/addassignment"><h1 align="center"><b class="saptaColor">Add </b>Assignment</h1></a>
			                </div>
						</div>
					</div>
				</div>
