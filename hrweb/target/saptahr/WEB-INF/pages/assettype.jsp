...
<html>
	...
	<body>
		...
		<!--Expense Type List-->
			<div id="assetTypeList">
				<h1 align="center" id="noassetTypeAvailable" class="hidden">Details <b class="saptaColor">Not Available</b> </h1>
				<div id="assetType" class="hidden">
					<h1><b class="saptaColor">Asset Type</b> List</h1>
					<table class="data">
						<tr>
			...
			<div id="confirmMsgDecline" class="hidden" >
				...
				<a href ="<%=request.getContextPath() %>/assettype" style="text-decoration: none"><input type="button" id="decline_yes" class="leftElement  MRGR10PX" value="Yes I'm" style="margin-top: 10px">&nbsp;</a>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){		
			...
			if(assetTypeListSize > 0){
				$("#assetType").removeClass("hidden");
			}else{ 
				$("#noassetTypeAvailable").removeClass("hidden");
			}
