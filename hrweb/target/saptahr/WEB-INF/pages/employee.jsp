			...
			<div id = "employee_details">
				<div class="dashboard">
					<div class="dashboardRow">
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/employee/viewemployee"><h1 align="center"><b class="saptaColor">View </b>Employee</h1></a>
			                 </div>
						</div>
								
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/employee/addemployee"><h1 align="center"><b class="saptaColor">Add </b>Employee</h1></a>
			                </div>
						</div>
					</div>
				</div>
