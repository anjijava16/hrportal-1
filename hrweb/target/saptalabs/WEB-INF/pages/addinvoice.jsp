...
<html>
					...
					<div class="responsive">
					   <table id="invoicetablecontent" class="data">
							   <tr>
								   ...
								   <th class=""><sup class="saptaColor">*</sup>Rate<span id="slashspan">/</span><span id="fixedtypeofperiodrate"></span> <span id="typeofperiodrate"></th>
							   ...
							   <tr id="invoicecontenttablerow_1">
							   	   ...
							   	   <td><div  margin: 0 auto;"><b style="float:left" class="datePicInput"><input name="servicefrom_1" id="servicefrom_1" readonly="readonly" type="text" class="datePcK datePicMob" style="float:left"/></b></div></td>
							   	   <td><div  margin: 0 auto;"><b style="float:left" class="datePicInput"><input name="serviceto_1" id="serviceto_1" readonly="readonly" type="text"  class="datePcK datePicMob" style="float:left"/></b></div></td>
							   	   <td class = "totalhrsrow"><div style="width: 95%; margin: 0 auto;"><input name="totalhrss_1"  class="perrateperiod" id="totalhrss_1" type="text" style=" text-align: right;" onkeypress="return validateNumeric(event)"/></div></td>
							   	   ...
							   	   <td><div style="width: 95%; margin: 0 auto;"><input name="total_1" id="total_1" disabled="disabled" class="inputdisable" style="text-align: right;" onkeypress="return validateNumericWithPrecision(event)"/></div></td>
	...
	<!--Content Area END-->
	  ...
	  $(document).ready(function(){
			...
			$("#pageTitle").html("<b class='saptaColor'>Add</b> Invoice");
			$(function() {
			...
			$(document).on('click','[id^="invoice_remove_"]', function(e) {
				...
				if(removeCount==2){
					$("#errorMsgContent").html("Atleast a detail sholud be required...");
					$.fancybox.open('#errorMsg');
			    }else{
			    	removeCount--;
			    	var netamount = 0;
			 ...
			 $('#addInvoice').click(function(){
				...
				if(validation == false){
					...
					$.fancybox.open('#errorMsg');
						...
						var amounttype = $("#amounttypeselect").val();
						if(amounttype == "i"){
							var totalamount = $("#subtotalamountdivision").html();
						}else{
							var totalamount = $("#totalamountdivision").html();
						}
						var servicetax = 0;
			...
			function addInvoiceDetails(){
				$('[id^="invoicecontenttablerow_"]').each(function(i, item) {
					...
					$("#userMsgContent").html("Invoice added successfully ...");
				...
				if(periodperrate != ""){
					...
					$('[id^="netamt_"]').each(function(i, item) {
						...
						if(netamount != "" && netamount != null && netamount != 0){
							...
							completeLastTotal = lastTotal.toFixed(2);
							if($("#amounttypeselect").val() == "i"){
								var servicetax = (parseFloat(completeLastTotal) * 14.5) / 100;
								$("#servicetax").html(servicetax.toFixed(2));
								$("#subtotalamountdivision").html(completeLastTotal);
