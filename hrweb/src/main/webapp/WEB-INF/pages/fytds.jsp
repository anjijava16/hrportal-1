	...
	<script>
		$(document).ready(function(){
			...
			$(document).on('click', '.fymonthlist' ,function(){
				...
				var resourceURL = $("#contextpath").val()+"/tds/viewfytds/"+monthYearVal;
			...
			$("#tdspdfreport").click(function() {
				...
				document.location.href =  $("#contextpath").val()+"/tdspdfreport?startDate="+startDate+"&endDate="+endDate;
			});
			
			function finalYearReportProcess(currentdate, nextYear){
				var completeTotalAmount = 0;
				var resourceURL = $("#contextpath").val()+"/fyreports/gettdsreport/"+currentdate+"/"+nextYear;
				$.ajax({
					url : resourceURL,
					type : 'GET',
					dataType : 'json',
