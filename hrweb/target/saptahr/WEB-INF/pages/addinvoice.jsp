	...
	<body>
		...
		<!--Content Area START-->
			<div id="contentArea">
				<div id="vendor">
					<h1>
					   <b class="saptaColor">Add</b> Invoice
					</h1>
					<div id = "customerselect" class="cmnTable">
						<table width = "443px" align ="center">
							<tr>
								<td align="right" width = "150px"> <sup class="saptaColor">*</sup>Choose Customer</td>
								<td>:</td>
								<td align="left">						
									<select id="custselect" class="leftElement selectBox" tabindex="2" style="width: 200px; margin:0; text-align: center;">
					...
					<div id = "projselect" class="cmnTable hidden">
						<table width = "443px" align ="center">
							<tr>
								...
								<td>:</td>
								<td align="left">	
									<select id="selectproject"  class="leftElement selectBox" tabindex="2" style="width: 200px; margin:0; text-align: center;">
									</select>
								</td>
							</tr>
						</table>
					</div>
					<div id = "InvoiceNo" class="cmnTable hidden">
						<table width = "443px" align ="center">
							<tr>
								<td align="right" width = "167px"> <sup class="saptaColor">*</sup>Invoice Number</td>
								<td>:</td>
								<td align="left">						
										<input id="invoiceno" disabled="disabled" class="inputdisabletxtbold" style="width: 215px;" />
								</td>
							</tr>
						</table>
					</div>
					<table id="invoice" class="hidden">
						<tr>
							<td align="right"><sup class="saptaColor">*</sup>Invoice Date :</td>
							<td><input name="invdate" id="invdate" type="text" style="width: 215px;" /></td>
							<td align="right"><sup class="saptaColor">*</sup>Due Date :</td>
							<td><input name="duedates" id="duedates" type="text" style="width: 215px;"/></td>
						</tr>
						<tr>
					...
					<div id="confirmMsg" class="hidden" >
						...
						<a href ="<%=request.getContextPath() %>/invoice" style="text-decoration: none"><input type="button" id="decline_yes" class="leftElement  MRGR10PX" value="Yes I'm" style="margin-top: 10px"></a>
					</div>
					<%-- <div id="userMsg" class="hidden">
						<h1><b class="saptaColor">Notification</b></h1>
						<div id="userMsgContent"></div>
						<div class="clearWidth MRGT10PX">
							<a href="<%=request.getContextPath() %>/invoice" ><input type="button" value="Ok" id="user" /></a>
						</div>
					</div> --%>
				</div>
			</div>
	...
	<footer>powered by <b><a href="http://saptalabs.com" target="_blank">saptalabs.com</a></b><sup>TM</sup>,&nbsp;copyright@2015 </footer>
	  ...
	  $(document).ready(function(){
			...
			$('#addInvoice').click(function(){
				...
				var validation = true;
				//invoice
				var custid = $("#custselect").val();
				var prjctid = $("#selectproject").val(); 
				var invoicedate = $("#invdate").datepicker().val();
				...
				if(custid == "" || custid.length == 0) validation = false;
				if(prjctid == "" || prjctid.length == 0) validation = false;
				...
				if(validation == false){
					...
					var resourceURL = $("#contextpath").val()+"/invoice/add/"+invoicedate+"/"+duedate+"/"+dueamount+"/"+amounttype+"/"+prjctid+"/"+custid+"/"+invoiceno;
					$.ajax({
						url : resourceURL,
						type : 'GET',
						dataType : 'json',
