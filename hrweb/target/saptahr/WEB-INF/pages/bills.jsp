				...
				<div id = "Invoicetracking">
					<div class="dashboard">
						<div class="dashboardRow">
							<div class="cellA">
								<div class="info">
									<a href="<%=request.getContextPath() %>/bills/viewbills""><h1 align="center"><b class="saptaColor">View </b>Bills</h1></a>
				               </div>
						</div>
								
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/bills/addbill"><h1 align="center"><b class="saptaColor">Add </b>Bill</h1></a>
				               </div>
							</div>
						</div>
					</div>
