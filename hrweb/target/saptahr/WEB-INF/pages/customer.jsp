				...
				<div id = "employee_details">
					<div class="dashboard">
						<div class="dashboardRow">
							<div class="cellA">
								<div class="info">
									<a href="<%=request.getContextPath() %>/customer/viewcustomer"><h1 align="center"><b class="saptaColor">View </b>Customer</h1></a>
				               </div>
							</div>
							<div class="cellA">
								<div class="info">
									<a href="<%=request.getContextPath() %>/customer/addcustomer"><h1 align="center"><b class="saptaColor">Add </b>Customer</h1></a>
				               </div>
							</div>
						</div>
					</div>
