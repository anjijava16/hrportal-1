				...
				<div  align="center" style="width: 100%;" class="amount_table">
					<table id="pttable"  align ="center" class="optionTable" >
						<tr >
							...
							<td align="left"  class="fyBillsPaidTd PADDLFT1PX BLD" ><span style="margin-left: 10px;font-weight:bold;">&#x20B9;</span><input id="currenttotalamttd" disabled style="border: 0;background-color: white;font-weight:bold;width: 100px; padding: 0px;" /></td>
			 ...
			 $('#ptaxtable').DataTable({
			      ...
			      "footerCallback": function ( row, data, start, end, display ) {
			            ...
			            pageTotal = api
			             ...
			             $("#currenttotalamttd").val(pageTotal);   
