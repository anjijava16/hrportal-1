			...
			<div id = "employee_details">
				<div class="dashboard">
					<div class="dashboardRow">
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/project/viewproject"><h1 align="center"><b class="saptaColor">View </b>Project</h1></a>
			                 </div>
						</div>
								
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/project/addproject"><h1 align="center"><b class="saptaColor">Add </b>Project</h1></a>
			                </div>
						</div>
					</div>
				</div>
