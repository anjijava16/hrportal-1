...
<html>
		...
		<div id="innerContainer">
			...
			<div id="totaldiv1" align="center" style="width:100%">
				<table  class="optionTable" >
					<tr>
							<td class="currenttotalamtrupyatd1" align="right" style="margin-left:auto; margin-top:0">Service Tax&nbsp;Amount&nbsp;Paid&nbsp;:</td>
	...
	<script>
		$(document).ready(function(){
			$("#pageTitle").html("Service Tax <b class='saptaColor'>Report</b>");
			...
			$(document).on('click', '.fymonthlist' ,function(){
				...
				var resourceURL = $("#contextpath").val()+"/servicetax/viewfyservicetax/"+monthYearVal;
			...
			$("#tdspdfreport").click(function() {
				...
				document.location.href =  $("#contextpath").val()+"/empsevicetaxpdfreport?startDate="+startDate+"&endDate="+endDate;
			});
					...
					success: function(data) {
						...
						if(successflag == "true"){
							...
							$.each(results, function (i, result){
								dueDate.push(result.taxdatemonth);
							});
							var dueAmount = 0;
							var count = 1;
							var flag = 1;
							...
							for(var i=0; i<newDueDate.length; i++){
								...
								var resultCount = 0;
								$.each(results, function (i, result){
										var fullDueDateFormated = stringToDateConversion(result.taxdatemonth);
