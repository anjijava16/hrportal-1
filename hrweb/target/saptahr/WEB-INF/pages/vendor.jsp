				...
				<div id = "vendor_details">
					<div class="dashboard">
						<div class="dashboardRow">
							<div class="cellA">
								<div class="info">
									<a href="<%=request.getContextPath() %>/vendordetails/viewvendor"><h1 align="center"><b class="saptaColor">View </b>Vendor</h1></a>
				               </div>
						</div>
								
						<div class="cellA">
							<div class="info">
								<a href="<%=request.getContextPath() %>/vendordetails/addvendor"><h1 align="center"><b class="saptaColor">Add </b>Vendor</h1></a>
				               </div>
							</div>
						</div>
					</div>
