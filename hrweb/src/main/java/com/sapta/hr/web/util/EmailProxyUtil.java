...
public class EmailProxyUtil {
	public static void sendEmail(ByteArrayOutputStream baos, String strCurrentMonth, String employeeid, final HttpServletRequest request, HttpServletResponse res) throws IOException, NumberFormatException, AppException, ServletException {
		...
		try{
			...
			msg.setSubject(CommonConstants.EMAIL_SUB+" "+strCurrentMonth);
	       ...
	       // String imagelocation = request.getServletContext().getRealPath("resources/images/logo.png");
	        ...
	        rootMap.put("to",strCurrentMonth);
	        ...
	        messageBodyPart.setFileName(employeeid+"_"+strCurrentMonth + CommonConstants.DOT_PDF);
	        multipart.addBodyPart(messageBodyPart);
