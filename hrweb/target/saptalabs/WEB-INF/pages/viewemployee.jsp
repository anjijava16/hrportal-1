...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<%@include file="head.jsp"%>
		...
		<body>
			...
			<div class="tabsMenu" >
				<div class="tabImagLt"><a href="#tab21"><img src="<%=request.getContextPath() %>/resources/images/previous.png" alt="Previous" style="width:15px;"/></a></div>
					<div class="scrl" >
					 	 <div class="scrlMenu">
				...
				<div class="tabImagRt"><a href="#tab15"><img src="<%=request.getContextPath() %>/resources/images/nextLeft.png" alt="Next" style="width:15px;"></imag></a></div>	
			</div>	
							...
							<div class = "content">
								...
								<table class="tableContent">
									...
									<tr>
										...
										<td class="value"><input id="emp_totalexp" disabled="disabled" class="inputdisable" onkeypress="return validateNumericWithPrecision(event)"></input></td>
									</tr>
									<tr>
										<td class="lableContent">Relevent Experience</td>
										<td class="value"><input id="emp_releventexp" disabled="disabled" class="inputdisable" onkeypress="return validateNumericWithPrecision(event)"></input></td>
									</tr>
									<tr>
						...
						<div class = "content pop_content">
							...
							<table>
								...
								<tr>
									...
									<td><input name="education_rankscholarship" id="education_rankscholarship" type="text" /></td>
			...
			$("#update").click(function() {
				$("body").css("cursor", "progress");
					...
					if(validation == false){
						...
						var resourceURL = $("#contextpath").val()+"/employee/update/"+id+"/"+fname+"/"+mname+"/"+lname+"/"+email+"/"+personalemail+"/"+mobile+"/"+phone+"/"+passport+"/"+pplaceofissued+"/"+pvalidupto+"/"+dlno+"/"+status+"/"+pan+"/"+aadharno+"/"+pfno;
							$.ajax({
								url : resourceURL,
								type : 'GET',
								dataType : 'json',
						...
						success: function(data) {
							...
							if(successflag == "true"){
								$.each(results, function (i, result) {
									...
									$("#optional_rdate").html((result.rdate == undefined || result.rdate == null || result.rdate.length <= 0) ? "-" : result.rdate);
					...
					success: function(data) {
						...
						if(successflag == "true"){
							$.each(results, function (i, result) {
								...
								$("#optional_jdate").html((result.jdate == undefined || result.jdate == null || result.jdate.length <= 0) ? "-" : result.jdate);
								$("#rdate").val((result.rdate == undefined || result.rdate == null || result.rdate.length <= 0) ? "-" : result.rdate);
								$("#optional_rdate").val((result.rdate == undefined || result.rdate == null || result.rdate.length <= 0) ? "-" : result.rdate);
								$("#emergencyno").val((result.emergencyno == undefined || result.emergencyno == null || result.emergencyno.length <= 0) ? "-" : result.emergencyno);
								$("#joininglocation").val((result.joininglocation == undefined || result.joininglocation == null || result.joininglocation.length <= 0) ? "-" : result.joininglocation);
								$("#marital").val((result.maritalstatus == undefined || result.maritalstatus == null || result.maritalstatus.length <= 0) ? "-" : result.maritalstatus);
								if(result.maritalstatus =="m"){
