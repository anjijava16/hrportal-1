	...
	<html>
							...
							<div class = "nav"> Employee Details</div>
								<table class="oddTd50P">
									...
									<tr id="descriptiontablerow" class="hidden">	
										...
										<td><textarea  class="empAccdntDesc" id="illnessdescr" name="illnessdescr"></textarea></td>
									</tr>
								</table>
						</div>
						<div class="clearWidth">
							...
							<div class="responsive">
								<table class="data Education" id="emp_education_Table">
									...
									<tr id="education_dynamictr_1">
										...
										<td><input name="emp_rankscholership_1" id="emp_rankscholership_1" type="text" placeholder="First,Second" /></td>
							...
							<div class="responsive">
								<table class="data" id="emp_languageknown_Table">
									...
									<tr id="languageknown_dynamictr_1">
										<td class="emp_res_lang"><input name="emp_languageknown_language_1" id="emp_languageknown_language_1" type="text"  onkeypress="return ValidateAlpha(event)"/></td>
										<td class="emp_res_lang">
						...
						<div class = "content">
							...
							<table>
								<tr>
									...
									<td>
										<input name="emp_totalexp" id="emp_totalexp" type="text"  onkeypress="return validateNumericWithPrecision(event)" style="width: 20px; text-align: center;">years</input>
										<input name="emp_totalexp_mnths" id="emp_totalexp_mnths" type="text"  onkeypress="return validateNumericWithPrecision(event)" style="width: 20px; text-align: center;">months</input>
									</td>
									<td align="right"><sup class="saptaColor" id="">*</sup>Relevent Experience&nbsp;:</td>
									<td>
										<input name="emp_relexp" id="emp_relexp" type="text" onkeypress="return validateNumericWithPrecision(event)" style="width: 20px; text-align: center;">years</input>
										<input name="emp_relexp_mnths" id="emp_relexp_mnths" type="text" onkeypress="return validateNumericWithPrecision(event)" style="width: 20px; text-align: center;">months</input>
									</td>
								</tr>
								<tr>
		...
		function white_space(field)
		{
			...
			$(document).ready(function(){
				...
				$("#pageTitle").html("<b class='saptaColor'>New</b> Employee");
					...
					$('#emp_culturals_next').click(function() {
					 ...
					 $('#emp_about_btn').click(function() {
							$("body").css("cursor", "default");
								...
								var emptotalexperience = "";
								var empreleventexperience = "";
								...
								if(totexpmnths == 0 && totexpyrs == 0){
									...
									emptotalexperience = totexpyrs +"."+ totexpmnths;
								}
								
								var relexpyrs = $("#emp_relexp").val();
								var relexpmnths = $("#emp_relexp_mnths").val();
								...
								if(relexpmnths == 0 && relexpyrs == 0){
									empreleventexperience = "";
								}else{
									empreleventexperience = relexpyrs +"."+ relexpmnths;
								}
